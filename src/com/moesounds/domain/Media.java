...
public class Media {
	...
	public void updateMedia(MultipartFile file) {
		...
		try {
			...
			if(nullOrEmptyFile) throw new IllegalArgumentException("File can not be null or empty when updating media");
	 ...
	 * 
	 * This is package-private since the relationship should be managed on the Page side, not this side.
	 * @param page The Page this media is associated with.
	 */
